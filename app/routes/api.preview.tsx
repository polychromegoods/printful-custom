...
// Preview dimensions (smaller than print file, good for thumbnails)
...
/**
 * Public GET endpoint: /api/preview?text=ABC&style=script&color=%23000000
 * Returns a PNG image of the monogram preview overlaid on a hat silhouette.
 */
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  if (style === "script") {
    ...
    if (text.length === 3) {
      // Traditional block monogram: larger center letter
